        ...
        return (
            <div className="row text-content">
                ...
                <div className="offset-2 col-md-3">
                    <div>
                        <ConfigurableChart startLine={3} endLine={4} data={[40, 50, 80, 85, 55, 50, 40]} />
                    </div>
                    <div>
                        <ConfigurableChart startLine={3} endLine={4} data={[40, 80, 75, 65, 55, 50, 40]} />
                    </div>
                    <div>
                        <ConfigurableChart startLine={3} endLine={4} data={[40, 60, 75, 80, 85, 50, 40]} />
                    </div>
                </div>
            </div>
        );
